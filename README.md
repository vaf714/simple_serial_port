...
## 准备工作
1. 根据不同的操作系统将 RXTX 开源包配置好，这里提供 windows 平台配置方法，其他平台请自行搜索，点击[这里](https://pan.baidu.com/s/1bKjMGm)下载，密码：1234
...
2. 将此模块编译成 jar 包加入项目编译路径中，或者直接将该模块作为依赖库引入项目中
3. 你的项目必须加入本项目中 lib 文件夹中的所有 jar 包
## 正式使用
1. 查找可用串口
